...
})({"cf4Oi":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "3be4427b055527dc";
"use strict";
...
},{}],"8KeZj":[function(require,module,exports,__globalThis) {
"use strict";
...
// form-builder.ts
const storage_1 = require("9e286c807804b98d");
const types_1 = require("c235f9a89ff01a17");
class FormBuilder {
    ...
    setupEventListeners() {
        ...
        if (newFormBtn) newFormBtn.addEventListener('click', ()=>this.createNewForm());
        ...
        this.container.addEventListener('click', (e)=>{
            ...
            if (target.matches('.delete-form-btn')) {
                const formId = target.getAttribute('data-form-id');
                if (formId && confirm('Are you sure you want to delete this form?')) this.deleteForm(formId);
            }
    ...
    previewForm(formId) {
        ...
        `;
            ...
            if (previewForm) previewForm.addEventListener('submit', (e)=>__awaiter(this, void 0, void 0, function*() {
                    e.preventDefault();
                    yield this.handleFormSubmission(form);
                }));
            if (backBtn) backBtn.addEventListener('click', ()=>this.renderFormsList());
        });
    }
    renderFormField(field, isPreview = false) {
        ...
        if (!isPreview) fieldHtml += `
            ...
            `;
        else fieldHtml += `<label>${this.escapeHtml(field.label)}</label>`;
                    ...
                    fieldHtml += `
                        <div class="radio-option">
                            <input type="radio" 
                                ...
                                ${field.required ? 'required' : ''}
                                ${!isPreview ? 'disabled' : ''}>
                            ${!isPreview ? `<input type="text" class="option-label" value="${this.escapeHtml(option.label)}">` : `<label>${this.escapeHtml(option.label)}</label>`}
                        </div>
                    `;
                });
                fieldHtml += '</div>';
    ...
    setupFormEditorListeners() {
        ...
        if (titleInput && this.currentForm) titleInput.addEventListener('change', (e)=>{
            if (this.currentForm) this.currentForm.title = e.target.value;
        });
        if (descInput && this.currentForm) descInput.addEventListener('change', (e)=>{
            if (this.currentForm) this.currentForm.description = e.target.value;
        });
        // Add Field button
        ...
        if (saveFormBtn) saveFormBtn.addEventListener('click', ()=>__awaiter(this, void 0, void 0, function*() {
                if (this.currentForm) {
...
},{"9e286c807804b98d":"6mXyf","c235f9a89ff01a17":"fXGQ6"}],"6mXyf":[function(require,module,exports,__globalThis) {
"use strict";
var __awaiter = this && this.__awaiter || function(thisArg, _arguments, P, generator) {
    function adopt(value) {
        return value instanceof P ? value : new P(function(resolve) {
...
class FormStorage {
    ...
    saveForm(form) {
        return __awaiter(this, void 0, void 0, function*() {
            ...
            if (existingIndex !== -1) forms[existingIndex] = Object.assign(Object.assign({}, form), {
                updatedAt: new Date().toISOString()
            });
            else forms.push(Object.assign(Object.assign({}, form), {
                createdAt: new Date().toISOString(),
                updatedAt: new Date().toISOString()
            }));
    ...
    saveFormResponse(response) {
        return __awaiter(this, void 0, void 0, function*() {
            ...
            allResponses[response.formId].push(Object.assign(Object.assign({}, response), {
                submittedAt: new Date().toISOString()
            }));
...
},{}],"fXGQ6":[function(require,module,exports,__globalThis) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
},{}]},["cf4Oi","8KeZj"], "8KeZj", "parcelRequire94c2")

//# sourceMappingURL=index.055527dc.js.map
